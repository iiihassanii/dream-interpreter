...
button.addEventListener('click', async () => {
  ...
  let output = document.getElementById('ai-res');
  let loader = document.getElementById('dots');
  ...
  try {
    let response = await fetch('https://dreaminterpreter-henna.vercel.app/dreaminterpreter', {
      method: 'POST',
      headers: {
    ...
    console.log(data);
    output.innerHTML = data.message[0].text
    output.hidden = false;
  } catch (error) {
